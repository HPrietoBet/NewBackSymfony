...
class getConsole_Command_CachePoolPruneService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['console.command.cache_pool_prune'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\CachePoolPruneCommand(new RewindableGenerator(function () use ($container) {
            ...
            yield 'cache.doctrine.orm.premiumpay.result' => ($container->privates['cache.doctrine.orm.premiumpay.result'] ?? $container->getCache_Doctrine_Orm_Premiumpay_ResultService());
            yield 'cache.doctrine.orm.premiumpay.query' => ($container->privates['cache.doctrine.orm.premiumpay.query'] ?? $container->getCache_Doctrine_Orm_Premiumpay_QueryService());
            yield 'cache.doctrine.orm.ggms.result' => ($container->privates['cache.doctrine.orm.ggms.result'] ?? $container->getCache_Doctrine_Orm_Ggms_ResultService());
            yield 'cache.doctrine.orm.ggms.query' => ($container->privates['cache.doctrine.orm.ggms.query'] ?? $container->getCache_Doctrine_Orm_Ggms_QueryService());
            yield 'cache.doctrine.orm.cuotas.result' => ($container->privates['cache.doctrine.orm.cuotas.result'] ?? $container->getCache_Doctrine_Orm_Cuotas_ResultService());
            yield 'cache.doctrine.orm.cuotas.query' => ($container->privates['cache.doctrine.orm.cuotas.query'] ?? $container->getCache_Doctrine_Orm_Cuotas_QueryService());
