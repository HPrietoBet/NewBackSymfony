...
class getConsole_Command_CachePoolPruneService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['console.command.cache_pool_prune'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\CachePoolPruneCommand(new RewindableGenerator(function () use ($container) {
            ...
            yield 'cache.doctrine.orm.old.result' => ($container->privates['cache.doctrine.orm.old.result'] ?? $container->getCache_Doctrine_Orm_Old_ResultService());
            yield 'cache.doctrine.orm.old.query' => ($container->privates['cache.doctrine.orm.old.query'] ?? $container->getCache_Doctrine_Orm_Old_QueryService());
