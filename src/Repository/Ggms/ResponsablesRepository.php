...
use App\Entity\Ggms\Responsables;
...
class ResponsablesRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(Responsables $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Responsables $entity, bool $flush = true): void
    {
