...
/**
 * CasasDeApuestasAcuerdosBack
 *
 * @ORM\Table(name="casas_de_apuestas_acuerdos_back", indexes={@ORM\Index(name="ix_id_casa", columns={"id_casa"})})
  * @ORM\Entity(repositoryClass="App\Repository\Ggms\CasasDeApuestasAcuerdosBackRepository")
 */
class CasasDeApuestasAcuerdosBack
{
    /**
     * @var int
     *
