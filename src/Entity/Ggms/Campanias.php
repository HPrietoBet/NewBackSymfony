 ...
 * Campanias
 *
 * @ORM\Table(name="campanias", indexes={@ORM\Index(name="casa", columns={"casa"}), @ORM\Index(name="id", columns={"id"}), @ORM\Index(name="connection_api", columns={"connection_api"})})
 * @ORM\Entity(repositoryClass="App\Repository\Ggms\CampaniasRepository")
 */
class Campanias
{
    /**
