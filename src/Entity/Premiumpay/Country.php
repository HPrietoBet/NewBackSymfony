 ...
 * Country
 *
 * @ORM\Table(name="country", indexes={@ORM\Index(name="ix_numcode", columns={"numcode"}), @ORM\Index(name="ix_iso", columns={"iso"})})
 * @ORM\Entity(repositoryClass="App\Repository\Premiumpay\CountryRepository") */
class Country
{
    /**
     * @var int
