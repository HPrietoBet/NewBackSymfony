 ...
 * CasasDeApuestas
 *
 * @ORM\Table(name="casas_de_apuestas", indexes={@ORM\Index(name="ix_id_cat", columns={"id_cat"})})
 * @ORM\Entity(repositoryClass="App\Repository\Main\CasasDeApuestasRepository")
 */
class CasasDeApuestas
{
    /**
     * @var int
     *
