 ...
 * FacturacionDatos
 *
 * @ORM\Table(name="facturacion_datos", indexes={@ORM\Index(name="ix_id_usu_fac", columns={"id_usu_fac"})})
 * @ORM\Entity(repositoryClass="App\Repository\Main\FacturacionDatosRepository")
 */
