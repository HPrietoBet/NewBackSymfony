 ...
 * LoginBusiness
 *
 * @ORM\Table(name="login_business")
 * @ORM\Entity(repositoryClass="App\Repository\Main\LoginBusinessRepository")
 */
class LoginBusiness
{
    /**
     ...
     * @var bool
     *
     * @ORM\Column(name="enlaces_iapuestas", type="boolean", nullable=false)
     */
    private $enlacesIapuestas = '0';

    /**
     * @var bool
     *
     * @ORM\Column(name="active_refunds", type="boolean", nullable=false)
     */
    private $activeRefunds = '0';
    ...
    public function getEnlacesIapuestas(): ?bool
    {
        return $this->enlacesIapuestas;
    }

    public function setEnlacesIapuestas(bool $enlacesIapuestas): self
    {
        $this->enlacesIapuestas = $enlacesIapuestas;

        return $this;
    }

    public function getActiveRefunds(): ?bool
    {
        return $this->activeRefunds;
    }

    public function setActiveRefunds(bool $activeRefunds): self
    {
        $this->activeRefunds = $activeRefunds;
