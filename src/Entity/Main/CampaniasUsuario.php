 ...
 * CampaniasUsuario
 *
 * @ORM\Table(name="campanias_usuario", indexes={@ORM\Index(name="id_usuario", columns={"id_usuario"}), @ORM\Index(name="ix_id_campania", columns={"id_campania"}), @ORM\Index(name="id_campania", columns={"id_campania"})})
 * @ORM\Entity(repositoryClass="App\Repository\Main\CampaniasUsuarioRepository")
 */
